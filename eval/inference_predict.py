...
# 4090 兼容性 & 性能稳定设置
# ==================================================
os.environ["CUDA_VISIBLE_DEVICES"] = "6,7"  # 可按需修改 GPU 编号
...
if __name__ == '__main__':
    ...
    # annotation_path = '/data_0/pl/VQL_Data/Train'
    annotation_path = '/mnt/data_2/pl/VQL_Data_test/VQL_Data_test'  # test
